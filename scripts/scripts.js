...
function recalculate() {
    ...
    costLabel.innerHTML = totalCost.toFixed(2); // Display the total cost with two decimal places
}
...
document.getElementById("duration-button").addEventListener("click", function() {
    ...
    duration = parseInt(newDuration) || 0; // Ensure that duration is a number, default to 0 if not.
